...
data= pd.read_csv("EdgeWeightDistributionLTP&BIOGRID.txt", delimiter = "\t")
f, ax = plt.subplots()
...
box_plot=sns.boxplot(data=data, x='Probabilistic Integrated Networks', y='Integrated score',showmeans=True,showfliers=True)
